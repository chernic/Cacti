...
# For PHP 5.3
sed -i 's@=&@=@g' /home/wwwroot/default/cacti/lib/adodb/adodb.inc.php
...
# echo '*/5 * * * * /usr/local/php/bin/php /home/wwwroot/default/cacti/poller.php > \
 /dev/null 2>/home/wwwroot/default/cacti/log/pooler-error.log' >> /etc/crontab
